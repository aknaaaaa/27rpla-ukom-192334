<nav class="navbar navbar-expand-lg navbar-light navbar-custom px-4">
    <div class="w-100 d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <button class="btn btn-dark me-3 font-aboreto">PESAN SEKARANG</button>
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="nav-link px-3" href="{{ route('layouts.register') }}"><img src="images/person-circle.svg"></a></li>
